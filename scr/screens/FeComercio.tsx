...
export function FeComercio(){
    ...
    function handleCard(card_id: int){
        ...
        switch(card_id){
            case 1:
                navigation.navigate('cartaodoempresario');
        ...
        <VStack  paddingTop={10}  flex={1} bg="primary.600">
           ...
           <HStack alignContent={"center"} alignItems={"center"} >
                <IconButton
                    ...
                    onPress={handleBakc} 
                />
                <Text fontFamily={"Roboto_700Bold"} color={"primary.700"} fontSize={22} >Fe Comercio</Text>
            </HStack>
            ...
            <VStack alignItems="center">
                <CardHome title="Cartão do Empresario" icon={Globe} 
                                    onPress={() => handleCard(1)}  />

                <CardHome title="SESC-PE" icon={Globe} 
                                    onPress={() => handleCard(2)}  />

                <CardHome title="SENAC-PE" icon={Globe} 
                                    onPress={() => handleCard(3)}  />
            </VStack>
            <View w="full" alignItems="center">
                <Image w={55} h={55} alt="logoaedigitals" source={imgaedigitals}/>
            </View>
